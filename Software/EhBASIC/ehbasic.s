...
Itempl:		.res 2		; temporary integer low byte
...
func_l:		.res 2		; function pointer low byte
...
Adatal:		.res 2		; array data pointer low byte
...
Obendl:		.res 2		; old block end pointer low byte
...
LAB_IGBY:	.res 28		; get next BASIC byte subroutine

LAB_GBYT	= LAB_IGBY + 6	; get current BASIC byte subroutine
Bpntrl		= LAB_GBYT + 1	; BASIC execute (get byte) pointer low byte
Bpntrh		= Bpntrl+1	; BASIC execute (get byte) pointer high byte

;		= $D7		; end of get BASIC char subroutine

Rbyte4:		.res 4		; extra PRNG byte
...
Decss:		.res 17		; number to decimal string start
Decssp1		  = Decss+1	; number to decimal string start

;		  = $F2		; decimal string end
...
ccflag:		.res 1		; BASIC CTRL-C flag, 00 = enabled, 01 = dis
ccbyte:		.res 1		; BASIC CTRL-C byte
ccnull:		.res 1		; BASIC CTRL-C byte timeout

VEC_CC:		.res 2		; ctrl c check vector

VEC_IN:		.res 2		; input vector
VEC_OUT:	.res 2		; output vector
VEC_LD:		.res 2		; load vector
VEC_SV:		.res 2		; save vector
...
Ibuffe		= *		; end of input buffer

; start of user RAM (set as needed, should be page aligned)
Ram_base	  = __RAM_START__
; end of user RAM+1 (set as needed, should be page aligned)
